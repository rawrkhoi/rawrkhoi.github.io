...
_.first = (array, number) => {
    ...
    if (Array.isArray(array) === false || number < 0) {
        // if not return []
        return [];
    // check if no number return array[0]
...
_.each = (collection, action) => {
    ...
    if (Array.isArray(collection)) {
        ...
        for (var i = 0; i < collection.length; i++) {
            // perform action on each element, index, and collection
    ...
    // if object
        ...
        for (var key in collection) {
            // perform action on value, key, and collection
...
_.filter = (array, test) => {
    // empty array for true elements
    let newArray = [];
    // loop through array caling each in a function
    for (var i = 0; i < array.length; i++){
...
_.reject = (array, test) => {
    ...
    //     }
    //  } return newArray;
    return _.filter(array, function(array, test) {
        return !test(array);
    });
};
...
_.map = (collection, action) => {
    ...
    let newArray = _.each(collection, action);
    return newArray;
